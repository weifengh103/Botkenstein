...
if 'arm' in sys.platform:
    import RPi.GPIO as GPIO
else:
    # Use a mocking library or alternative library for PC development
    try:
        import Mock.GPIO as GPIO  # Example using FakeRPi library
    except ImportError:
        import Mock.GPIO as GPIO  # Another example with different mocking library
